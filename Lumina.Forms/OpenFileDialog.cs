...
/// <summary>
/// Represents a standard dialog box that prompts the user to open a file.
/// </summary>
public sealed class OpenFileDialog : IDisposable
{
    ...
    /// </summary>
    public string Title { get; set; } = "打开";
    ...
    {
        string value = string.IsNullOrWhiteSpace(filter) ? "所有文件 (*.*)|*.*" : filter;

...
/// <summary>
/// Defines the application-wide visual style defaults used by LuminaForms windows.
/// </summary>
public sealed class ApplicationVisualStyleSettings
{
    ...
    /// <summary>
    /// Gets or sets a value indicating whether LuminaForms should apply a Lumina backdrop by default.
    /// </summary>
    ...
    /// to let LuminaForms detect the best default from the current operating system.
    /// </summary>
    public VisualStyleKind PreferredVisualStyle { get; set; } = VisualStyleKind.System;

    /// <summary>
    /// Gets or sets the preferred window effect. Set to <c>null</c> to let LuminaForms pick the OS-appropriate default.
    /// </summary>
    public EffectKind? PreferredEffect { get; set; }

    /// <summary>
    /// Gets or sets the options used for the preferred effect. When omitted, LuminaForms chooses sensible defaults.
    /// </summary>

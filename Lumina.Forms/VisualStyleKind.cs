...
/// <summary>
/// Describes the system-aligned visual style family that LuminaForms should emulate by default.
/// </summary>
public enum VisualStyleKind
{
    /// <summary>
    /// Let LuminaForms choose the most appropriate style for the current operating system.
    /// </summary>
    System = 0,
